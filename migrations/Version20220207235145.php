 ...
 */
final class Version20220207235145 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program ADD updated_at DATETIME NOT NULL');
    }
